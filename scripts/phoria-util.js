...
(function() {
   ...
   Phoria.Util.sortPolygons = function sortPolygons(polygons, worldcoords)
   {
      ...
      polygons.sort(function sortPolygonsZ(f1, f2) {
         ...
         if (f1._avz === 0)
         {
            ...
            {
               f1._avz += worldcoords[ verts[i] ][2];
            }
            f1._avz = f1._avz / verts.length;
         }
         ...
         if (f2._avz === 0)
         {
            ...
            for (var i=0; i<verts.length; i++)
            {
               f2._avz += worldcoords[ verts[i] ][2];
            }
            f2._avz = f2._avz / verts.length;
         }
   ...
   Phoria.Util.sortEdges = function sortEdges(edges, coords)
   {
      ...
      edges.sort(function sortEdgesZ(f1, f2) {
         // average z of first edge
         if (f1._avz === 0)
         {
            f1._avz = (coords[ f1.a ][2] + coords[ f1.b ][2]) * 0.5;
         }
         
         // average z of second edge
         if (f2._avz === 0)
         {
            f2._avz = (coords[ f2.a ][2] + coords[ f2.b ][2]) * 0.5;
         }
